...
{
	import org.flixel.*;
	public class Level_Test2 extends BaseLevel
	{
		//Embedded media...
		...
		public function Level_Test2(addToStage:Boolean = true, onAddSpritesCallback:Function = null)
		{
			...
			layerGroup1Ground.loadMap( new CSV_Group1Ground, Img_Group1Ground, 32,32,0,0,1,1 );
			...
			layerGroup1Water.loadMap( new CSV_Group1Water, Img_Group1Water, 32,32,0,0,1,16 );
