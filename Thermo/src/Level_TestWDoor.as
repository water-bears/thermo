...
package 
{
	...
	public class Level_TestWDoor extends BaseLevel
	{
		...
		[Embed(source="../assets/mapCSV_Group1_FreezeGates.csv", mimeType="application/octet-stream")] public var CSV_Group1FreezeGates:Class;
		[Embed(source="../assets/gatesflash.png")] public var Img_Group1FreezeGates:Class;
		[Embed(source="../assets/mapCSV_Group1_HeatGates.csv", mimeType="application/octet-stream")] public var CSV_Group1HeatGates:Class;
		...
		[Embed(source="../assets/mapCSV_Group1_Door.csv", mimeType="application/octet-stream")] public var CSV_Group1Door:Class;
		[Embed(source="../assets/doorflash.png")] public var Img_Group1Door:Class;
		[Embed(source="../assets/mapCSV_Group1_Key.csv", mimeType="application/octet-stream")] public var CSV_Group1Key:Class;
